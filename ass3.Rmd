...
# 9.
```{r velge bort noen kolonner, pluss legge til left_join}
g_c <- as_tibble(g_c) %>% # so it prints a little nicer
...
Første observasjon om forventet levetid for de forskjellige landene

```{r første observasjon om forventet levetid}
